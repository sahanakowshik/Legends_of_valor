...
//        this.grid = new Cell[GameConstants.boardSize][GameConstants.boardSize];
        for(int i=0;i<GameConstants.boardSize;i++){
            for(int j=0;j<GameConstants.boardSize;j++){
                ...
                this.getGrid()[i][j].setHeroSet(false);
            }
        }
    }

    public void addPlayer(ValorPlayer player){
        this.getGrid()[GameConstants.boardSize-1][0].setHero(player.getHeroes().get(0));
        player.getHeroes().get(0).setI(GameConstants.boardSize-1);
        player.getHeroes().get(0).setJ(0);
        this.getGrid()[GameConstants.boardSize-1][0].setHeroSet(true);
        this.getGrid()[GameConstants.boardSize-1][3].setHero(player.getHeroes().get(1));
        player.getHeroes().get(1).setI(GameConstants.boardSize-1);
        player.getHeroes().get(1).setJ(3);
        this.getGrid()[GameConstants.boardSize-1][3].setHeroSet(true);
        this.getGrid()[GameConstants.boardSize-1][6].setHero(player.getHeroes().get(2));
        player.getHeroes().get(2).setI(GameConstants.boardSize-1);
        player.getHeroes().get(2).setJ(6);
        this.getGrid()[GameConstants.boardSize-1][6].setHeroSet(true);
    }
    ...
    public void addMonster(ValorPlayer player){
        ...
        this.getGrid()[0][1].setMonsterSet(true);
        ...
        this.getGrid()[0][4].setMonsterSet(true);
        ...
        this.getGrid()[0][7].setMonsterSet(true);
    }
    ...
    public boolean canMove(int i, int j){
        ...
        if(this.getGrid()[i][j] instanceof isAccessible)
            return true;
        else
            return false;
    }
    ...
    public void moveHero(int i, int j, Heroes hero){
        ...
        if(this.getGrid()[i][j] instanceof isAccessible){
            ...
            this.getGrid()[i][j].setHeroSet(true);
            this.getGrid()[hero.getI()][hero.getJ()].setHeroSet(false);
//            this.getGrid()[this.i][this.j].setPlayer(null);
            hero.setI(i);
            hero.setJ(j);
        }
    }
    ...
    public void moveMonster(int i, int j, Monsters monster){
        ...
        if(this.getGrid()[i][j] instanceof isAccessible){
            ...
            this.getGrid()[i][j].setMonsterSet(true);
            this.getGrid()[monster.getI()][monster.getJ()].setMonsterSet(false);
//            this.getGrid()[this.i][this.j].setPlayer(null);
            monster.setI(i);
            monster.setJ(j);
        }
